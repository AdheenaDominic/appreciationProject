(function (root) {
    ...
    function CanvasTextWrapper(canvas, text, options) {
        ...
        var MAX_TXT_WIDTH = opts.maxWidth;
        console.log('MAX_TXT_WIDTH', opts.maxWidth, MAX_TXT_WIDTH)
        ...
        function checkLength(words) {
            ...
            words.forEach(function (word, index) {
                ...
                if (tokenLen > MAX_TXT_WIDTH) {
                    for (var k = 0;
                        (context.measureText(testString + word[k]).width <= MAX_TXT_WIDTH) && (k < word.length); k++) {
                        testString += word[k];
                    }
        ...
        function drawText() {
            ...
            for (var i = 0; i < lines.length; i++) {
                ...
                if (textPos.y > opts.maxHeight) return;
